...
@echo off
echo.
set /p TieneCovid19=S
cls
echo.
if %TieneCovid19%==S echo Tienes Covid 19
echo.
pause
exit
...
rem set /a Ustedtienecovid19=%fiebre%+%olfato%+%hipert%==S
rem echo Su resultado es: %Ustedtienecovid19%
